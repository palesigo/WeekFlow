...
import { createActivity, deleteActivity, listActivities, updateActivity, type ActivityInput } from '../services/activityService';

interface ActivityState {
  activities: Activity[];
  loading: boolean;
  load: (date?: string) => Promise<void>;
  add: (input: ActivityInput) => Promise<void>;
